<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Admin.Products" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section id="Section1" class="content" runat="server">
      <div class="row">
        <div class="col-xs-12">
         ...
         <%-- <div class="box">
            <div class="box-header">
              <h3 class="box-title"><center>Please Fill Registration Details</center></h3>
            </div>--%>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box-body">
              ...
              <div class="box-footer">
                  <center>
                      <asp:Button ID="Button3" runat="server" Text="Submit" Width="75px" Height="40px" CssClass="btn-primary" OnClick="Button3_Click"></asp:Button>
