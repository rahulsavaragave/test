<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mall_Detail1.aspx.cs" Inherits="Admin.Mall_Detail1" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <%--  <h3 class="box-title">Data Table With Full Features</h3>--%>
              <span class="pull-right"> <a href="Mall_Registration.aspx" class="btn bg-olive">Add New Mall Registration</a></span>
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Search Mall" />
                <br />
                <br />
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="53px" Width="1006px">
