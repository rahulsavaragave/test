<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Try.aspx.cs" Inherits="Admin.Try" %>
          ...
          <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     <asp:DropDownList ID="ddlMall" runat="server" class="form-control" TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="ddlMall_SelectedIndexChanged"></asp:DropDownList>
                </div>
                </div>
              <div class="form-group">
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     <asp:DropDownList ID="ddlShop" runat="server" class="form-control" TabIndex="2" OnSelectedIndexChanged="ddlShop_SelectedIndexChanged"></asp:DropDownList>
                </div>
                </div>  
               <div class="form-group">
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     <asp:DropDownList ID="ddlProdCat" runat="server" class="form-control" AutoPostBack="True"  TabIndex="3" OnSelectedIndexChanged="ddlProdCat_SelectedIndexChanged"></asp:DropDownList>
               ...
               <div class="form-group">
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                    <asp:DropDownList ID="ddlProdBrand" runat="server" class="form-control" TabIndex="3" ></asp:DropDownList>
                </div>
                </div>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     <asp:DropDownList ID="ddlProdName" runat="server" class="form-control" TabIndex="5" AutoPostBack="True" ></asp:DropDownList>
                </div>
                </div>   
...
<%--                <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control" TabIndex="10"></asp:DropDownList>--%>
              ...
              <div class="box-footer">
                  <center>
                      <asp:Button ID="Button3" runat="server" Text="Submit" Width="75px" Height="40px"  CssClass="btn-primary" TabIndex="13" />
