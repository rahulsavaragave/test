<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mall_Details.aspx.cs" Inherits="Admin.Mall_Details" %>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-mini"><b>Maxgen</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Maxgen</b>Technology</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <li class="active"><a href="mall_details.html"><i class="fa fa-circle-o"></i> Mall Details</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Mall Registration</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <span class="pull-right"> <a href="mall_registration.html" class="btn bg-olive">Add New Mall Registration</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
