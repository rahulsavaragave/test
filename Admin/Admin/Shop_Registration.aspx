<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop_Registration.aspx.cs" Inherits="Admin.Shop_Registration" %>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="mall_name" placeholder="Enter Mall Name">--%>
                     <asp:DropDownList ID="DropDownList2" CssClass="form-control" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" ></asp:DropDownList>
                </div>
                </div>
                     
               <div class="form-group">
                <div class="col-md-4">
                  <label for="category">Floor</label>
                 </div>
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="mall_name" placeholder="Enter Mall Name">--%>
                     <asp:TextBox ID="txtfloor" runat="server" class="form-control" placeholder="Enter Mall Id" TabIndex="1" ></asp:TextBox>
                </div>
                </div>

              <div class="form-group">
                <div class="col-md-4">
                  <label for="category">Shop RegiNo</label>
                 </div>
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="owner_name" placeholder="Enter Owner Name">--%>
                     <asp:TextBox ID="txtregino" runat="server" class="form-control" placeholder="Enter Shop Registration Number" TabIndex="3" ></asp:TextBox>
                </div>
                </div>  
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="owner_name" placeholder="Enter Owner Name">--%>
                     <asp:TextBox ID="txtshopname" runat="server" class="form-control" placeholder="Enter shop Name" TabIndex="4" ></asp:TextBox>
                </div>
                </div>   
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="mall_name" placeholder="Enter Mall Name">--%>
                     <asp:TextBox ID="txtshopownername" runat="server" class="form-control" placeholder="Enter Shop Owner Name" TabIndex="5" ></asp:TextBox>
                </div>
                </div>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="owner_name" placeholder="Enter Owner Name">--%>
                     <asp:TextBox ID="txtshopcategory" runat="server" class="form-control" placeholder="Enter Category" TabIndex="6" ></asp:TextBox>
                </div>
                </div>   
               <div class="form-group">
                <div class="col-md-4">
              <label for="category">Contactno</label>
                 </div>
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="owner_name" placeholder="Enter Owner Name">--%>
                     <asp:TextBox ID="txtcontactno" runat="server" class="form-control" placeholder="Enter Contact No" TabIndex="7" ></asp:TextBox>
                </div>
                </div>  
             <div class="form-group">
                <div class="col-md-4">
               <label for="category">Email Id</label>
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="owner_name" placeholder="Enter Owner Name">--%>
                     <asp:TextBox ID="txtemailid" runat="server" class="form-control" placeholder="Enter Email Id" TabIndex="8" ></asp:TextBox>
                </div>
                </div>  
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
           			<%--<input class="form-control" type="text" name="mall_name" placeholder="Enter Mall Name">--%>
                     <asp:TextBox ID="txtusername" runat="server" class="form-control" placeholder="Enter User Name" TabIndex="9" ></asp:TextBox>
                </div>
                </div>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     ...
                     <%--<asp:TextBox ID="TextBox6" runat="server" class="form-control" placeholder="Enter Password" TextMode="Password"></asp:TextBox>--%>
                      <asp:TextBox ID="txtpassword" runat="server" class="form-control" placeholder="Enter Password"  TabIndex="10" TextMode="Password" ></asp:TextBox>
                </div>
                </div>   
          ...
          <%-- <div class="form-group">
                <div class="col-md-4">
                  <label for="product">No. Of Floors</label>
                 </div>
                 <div class="col-md-8">
                
                  <asp:TextBox ID="TextBox7" runat="server" class="form-control" placeholder="Enter No. of Floor" TabIndex="7" ></asp:TextBox>
                      </div>
                </div>
                ...
                <div class="form-group">
                <div class="col-md-4">
                  <label for="product_price">No. of Shops</label>
                 </div>
                 <div class="col-md-8">
            
                 
                     <asp:TextBox ID="TextBox8" runat="server" class="form-control" placeholder="Enter No. of Shops" TabIndex="8" ></asp:TextBox>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-8">
                     ...
                     <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" TabIndex="9"></asp:DropDownList>
                      </div>
                </div>
                ...
                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control" TabIndex="10"></asp:DropDownList>
                </div>
                </div>--%>
                ...
                <div class="col-md-4">
                  ...
                  <asp:TextBox ID="txtarea" runat="server" class="form-control" placeholder="Enter Area Ex:Deccan" TabIndex="11" ></asp:TextBox>
                </div>
                </div>
               <div class="form-group">
                <div class="col-md-4">
              ...
              <div class="box-footer">
                  ...
                  <%--<asp:Button ID="Button1" runat="server" Text="Submit" Width="75px" Height="40px"  CssClass="btn-primary"  TabIndex="13" OnClick="Button1_Click" />--%>
                      <asp:Button ID="Button3" runat="server" Text="Submit" Width="75px" Height="40px" CssClass="btn btn-primary" OnClick="Button3_Click"></asp:Button>
