                        ...
                        <div class="col-md-6 col-md-offset-6">
                            <div class="search-box" style="height:60px;" >
                                  ...
                                  <p style=" margin-left:7px; margin-top:10px;"><asp:TextBox  runat="server" placeholder="Search brands,products,events,movies by malls" MaxLength="100" name="search" CssClass="form-control"  Width="420px"  ID="txtsearch"></asp:TextBox></p>
                                    ...
                                    <p style="margin-left:450px; margin-top:-40px" ><i  class="fa fa-search"><asp:Button ID="Button2" runat="server"  Text="Search"  CssClass=" btn btn-default "  BorderWidth="0"  OnClick="Button2_Click" Height="25px" /></i></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" placeholder="select Mall Name" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" placeholder="Select Shop Name" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
                                                <asp:ListItem>Select Shop</asp:ListItem>
                                            </asp:DropDownList>
                                            <%--<select name="mall" class="form-control">
                            ...
                            <div class="navbar-collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <%--<li class="active"><a data-toggle="tab" href="#tab-1">ALL Products</a> </li>--%>
                                     <li class="active">
                                         <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">ALL Products</asp:LinkButton> </li>

                                     <li > <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Electronics</asp:LinkButton> </li>
                                   <%-- <li><a data-toggle="tab" href="#tab-2">Cloths</a> </li>--%>
                                     <li>
                                         <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">Cloths</asp:LinkButton> </li>
                                   <%-- <li><a data-toggle="tab" href="#tab-3">Foods</a> </li>--%>
                                     <li>
                                         <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click">Foods</asp:LinkButton></li>
                                    <%--<li><a data-toggle="tab" href="#tab-4">Accessories</a> </li>--%>
                                    <li>
                                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click">Accessories</asp:LinkButton> </li>
            ...
            <ItemTemplate>
                <table border="0">
                   ...
                   <tr> <td >
                     ...
                     <tr>
                        <td class="abc">
                          <b style="color:green"> Product Name:-</b> <asp:Label ID="Label2" runat="server" Font-Size:14px  Text='<%#Eval("P_Name") %>'></asp:Label> 
                             <br />
                         <b >Brand Name:-</b><asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval("PB_Brand_Name") %>'>LinkButton</asp:LinkButton>
                        </td>
                    </tr>
                    <tr ><td class="abc" style="text-decoration:line-through;font-family:'Times New Roman';font-size:medium; color:red" >Price Rs.<asp:Label ID="Label3" runat="server"  Text='<%#Eval("PR_Price") %>'></asp:Label></td></tr>
                     <tr> <td>
            ...
            <ItemTemplate>
                ...
                <table >
                   ...
                   <tr > <td>
                     ...
                     <tr>
                        <td class="abc">
                          <b  style="color:green"> Product Name:-</b> <asp:Label ID="Label2" runat="server" Text='<%#Eval("P_Name") %>'></asp:Label> 
                        </td>
                    </tr>
                    <tr ><td class="abc"  ><b style="color:red">Offer_Price Rs:-</b><asp:Label ID="Label1" runat="server" Text='<%#Eval("PR_OfferPrice") %>'></asp:Label></td></tr>
                    <tr ><td class="abc" style="text-decoration:line-through; font-size:medium; " >Price Rs.<asp:Label ID="Label3" runat="server"  Text='<%#Eval("PR_Price") %>'></asp:Label></td></tr>
                     <tr> <td>
