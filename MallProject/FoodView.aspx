book<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoodView.aspx.cs" Inherits="FoodView" %>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-2 box">
                        <div class="top-cart-contain pull-right">
                            <div class="tag_shop">
                                <div class="talent"><a href="Nearmall.aspx"><span class="head">Your Talent</span> </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2 box">
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="Userpage.aspx" class="act">Home</a></li>
                                <!-- Mega Menu -->
                                <li class="dropdown">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList5" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged"></asp:DropDownList>
                                           <%-- <select name="mall" class="form-control">
         ...
         <table>
           ...
           <div class="col-sm-5">
            <asp:DataList ID="DataList1" runat="server">
                <ItemTemplate>
                <asp:Image ID="Image1" runat="server" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("Image")) %>' Height="350" Width="400" CssClass="img1"></asp:Image>
                    </ItemTemplate>
            </asp:DataList>
            ...
            <asp:DataList ID="DataList2" runat="server"  RepeatColumns="5" Font-Size="Medium" ForeColor="Red">
                <ItemTemplate>
                   ...
                   <tr> <td>
                    ...
                    <tr ><td class="abc" font-family:'Times New Roman'; font-size:medium;" >Price Rs.<asp:Label ID="Label3" runat="server"  Text='<%#Eval("Price") %>'></asp:Label></td></tr>
                     <tr> <td>
                         
                         <asp:LinkButton ID="LinkButton2" runat="server" CommandName='<%#Eval("FoodId") %>' OnClick="LinkButton2_Click">View Info </asp:LinkButton>
                         
                         <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval("Food_Item") %>'>LinkButton</asp:LinkButton>
                       </td>
                       </tr>
                    <tr>
                        <td class="abc">
                           Food Name <asp:Label ID="Label2" runat="server" Font-Size:14px  Text='<%#Eval("Food_Name") %>'></asp:Label> 
                        </td>
                    </tr>
                </table>
                </ItemTemplate>
