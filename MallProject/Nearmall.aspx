<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nearmall.aspx.cs" Inherits="Nearmall" %>
...
<body class="cms-index-index cms-home-page">
    ...
    <div id="page">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="welcome-msg" style="font-weight: bold;">Welcome Shopping Mall </div>
                            </div>
        ...
        <div id="thmsoft-slideshow" class="thmsoft-slideshow">
            <div class="container">
                <div class="row"> <h1>Search By City and Area</h1>
                        <br /><br />
                    <div class="col-sm-5">
                        <!--<div class="col-inner ">
            ...
            <div class="img-block1"> <a href="#" title="Image"> <img src="images/mid-banner2.jpg"  alt="Image"></a> </div>
                        ...
                        <div class="col-sm-3">
                            <asp:Label ID="Label1" runat="server" Text="Select City" Font-Size="Medium"> Select City</asp:Label>
                        </div>
                        <div class="col-sm-9">
            ...
            <div class="img-block1"> <a href="#" title="Image"> <img src="images/mid-banner2.jpg"  alt="Image"></a> </div>
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Select City" Font-Size="Medium"> Select Area</asp:Label>
                        </div>
                        <div class="col-sm-9">
            ...
            <div class="img-block1"> <a href="#" title="Image"> <img src="images/mid-banner2.jpg"  alt="Image"></a> </div>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Display" CssClass="btn btn-primary" OnClick="Button1_Click" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="583px">
    ...
    <div class="row">
        ...
        <br />
          ...
          <div class="col-sm-9" style="text-align:justify;font-size:medium"> </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-12">
                        <div class=" pull-left col-xs-3 col-lg-3 ">
                            <h4>QUICK LINKS                 <li><a href="#" title="Payment">Payment</a></li>
