                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-2 box">
                        <div class="top-cart-contain pull-right">
                            <div class="tag_shop">
                                <div class="talent"><a href="Nearmall.aspx"><span class="head">Nearer Mall</span> </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2 box">
                        <div class="top-cart-contain pull-right">
                            <div class="tag_shop">
                                <div class="child"><a href="WebForm1.aspx"><span class="head">Kid's Talent</span> </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2 box">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="search-box">
                                    ...
                                    <asp:TextBox runat="server" placeholder="Search brands,products,events,movies by malls" MaxLength="100" name="search" ID="search"></asp:TextBox>
            ...
            <div class="img-block1"> <a href="#" title="Image"> <img src="images/mid-banner2.jpg"  alt="Image"></a> </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-7 col-xs-12">
                        ...
                        <div id="wowslider-container1">
                            <div class="ws_images">
                                <ul>
                                    <li><a href="#">
                                        <img src="data1/images/sli5.jpg" alt="wowslider" title="" id="wows1_0" height="500px" /></a></li>
                                    <li><a href="#">
                                        <img src="data1/images/sli8.jpg" alt="slide-img2" title="" id="wows1_1" height="500px" /></a></li>
                                    <li><a href="#">
                                        <img src="data1/images/sli3.jpg" alt="slide-img3" title="" id="wows1_2" height="500px" /></a></li>
                                    <li><a href="#">
                                        <img src="data1/images/sli0.jpg" alt="slide-img4" title="" id="wows1_3" height="500px" /></a></li>
                                </ul>
                            </div>
                    ...
                    <div class=" col-lg-3 col-md-3 col-sm-7 col-xs-12">
                        <div class="image-item"><a href="#" title="Image">
                            <img src="img/rhs-banner.jpg" class="img-responsive" alt="Image"></a> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
                                    ...
                                    <div class="slider-items slider-width-col4 products-grid block-content">
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="iPhone 6 Plus" href="product_detail.html">
                                                            <img alt="iPhone 6 Plus" src="img/product10.jpg">
                                                        </a>
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="action">
                                                                <button class="button btn-cart" type="button" title="" data-original-title="View More"><span>View More</span> </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Noise Smart Watch" href="product_detail.html">
                                                            <img alt="Noise Smart Watch" src="img/product11.jpg">
                                                        </a>
                                                        <div class="box-hover">
                                                            <ul class="add-to-links">
                                                                <li><a class="link-quickview" href="quick_view.html"></a></li>
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Morphy Optimo Kettle" href="product_detail.html">
                                                            <img alt="Morphy Optimo Kettle" src="img/product12.jpg">
                                                        </a>
                                                        <div class="box-hover">
                                                            <ul class="add-to-links">
                                                                <li><a class="link-quickview" href="quick_view.html"></a></li>
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Omega J8004 Juicer" href="product_detail.html">
                                                            <img alt="Omega J8004 Juicer" src="img/product13.jpg">
                                                        </a>
                                                        <div class="new-label new-top-right">new</div>
                                                        <div class="box-hover">
                                                            <ul class="add-to-links">
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="HI114 Dry Iron" href="product_detail.html">
                                                            <img alt="HI114 Dry Iron" src="img/product14.jpg">
                                                        </a>
                                                        <div class="box-hover">
                                                            <ul class="add-to-links">
                                                                <li><a class="link-quickview" href="quick_view.html"></a></li>
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <a class="product-image" title="Food Processor" href="product_detail.html">
                                                            <img alt="Food Processor" src="img/product16.jpg">
                                                        </a>
                                                        <div class="box-hover">
                                                            <ul class="add-to-links">
                                                                <li><a class="link-quickview" href="quick_view.html"></a></li>
            ...
            <ItemTemplate>
                <table border="0">
                   ...
                   <tr> <td >
                        <asp:Image  ID="Image1"  runat="server" CssClass="imgrotate" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("PR_Image")) %>' Height="210" Width="210" /></td>
                       </tr>
                     <tr>
                        <td class="abc">
                          <b style="color:blue; font-family:Arial;font-size:medium;"> Product Name: </b> <asp:Label ID="Label2" runat="server" Font-Size="16px" Text='<%#Eval("P_Name") %>'></asp:Label> 
                             <br /><br />
                         <b style="color:green;font-family:Arial;font-size:medium;">Brand Name: <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="16px" Text='<%#Eval("PB_Brand_Name") %>'>LinkButton</asp:LinkButton><br /><br />
                        </td>
                    </tr>
                    <tr ><td class="abc" style="text-decoration:line-through;font-family:Arial;font-size:medium; color:black" >Price Rs.<asp:Label ID="Label3" runat="server" Font-Size="16px" Text='<%#Eval("PR_Price") %>'></asp:Label><br /><br /></td></tr><br /><br />
                     <tr> <td>
                         
                       <asp:LinkButton ID="LinkButton7" CssClass="button btn-cart"  runat="server"  CommandName='<%#Eval("PR_Id") %>' OnClick="LinkButton7_Click" >View Info</asp:LinkButton>
                    ...
                    <!-- Start Featured Slider -->
                      <div class="featured-pro">
                        ...
                        <br/>
                                ...
                                <asp:DataList ID="DataList2" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" RepeatLayout="Table">
            ...
            <ItemTemplate>
                ...
                <table >
                   ...
                   <tr > <td>
                        ...
                        <asp:Image ID="Image1" runat="server" style="height:200px;width:200px;" CssClass="img1"  ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("PR_Image")) %>'/></td>
                       </tr>
                     <tr>
                        <td class="abc">
                          <b  style="color:blue; font-size:medium";> Product Name:</b> <asp:Label ID="Label2" runat="server" Font-Size="16px" Text='<%#Eval("P_Name") %>'></asp:Label> <br /><br />
                        </td>
                    </tr>
                    <tr ><td class="abc"  ><b style="color:red;font-size:medium;">Offer Price Rs:</b><asp:Label ID="Label1" runat="server" Font-Size="16px" Text='<%#Eval("PR_OfferPrice") %>'></asp:Label><br /><br /></td></tr><br /><br />
                    <tr ><td class="abc" style="text-decoration:line-through; font-size:medium;" >Price Rs:<asp:Label ID="Label3" runat="server" Font-Size="16px" Text='<%#Eval("PR_Price") %>'></asp:Label><br /><br /></td></tr>
                     <tr> <td>
                         
                         <asp:LinkButton ID="LinkButton8" CssClass="button btn-cart" runat="server" CommandName='<%#Eval("PR_Id") %>' OnClick="LinkButton8_Click">View Info</asp:LinkButton>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 blog-preview_item">
                                                <div class="blog-post">
                                                    ...
                                                    <div class="blog-preview_info">
                                                        <ul class="post-meta">
                                                            <li><i class="fa fa-comments"></i><a href="#">37 comments                                              <li><i class="fa fa-calendar"></i>2016-01-15</li>
                                                        </ul>
                ...
                <div class="col-md-3">
                    <div class="hot-deal">
                        <div class="title">Hot Deal</div>
                             <asp:DataList ID="DataList3" runat="server" BackColor="Gray" BorderColor="#666666"
            ...
            Font-Names="Verdana" Font-Size="Small" GridLines="Both">
                   ...
                   <tr> 
                       <td>
                        ...
                        <asp:Image ID="Image1" runat="server" style="height:250px;width:250px;" CssClass="img1"  ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("PR_Image")) %>'/>
                          </marquee>
                           </td>
                       </tr>
                                        ...
                                        <div class="inner-block">
                                            <div class="auther-img">
                                                ...
                                                <asp:DataList ID="DataList4" runat="server">
                                                    <ItemTemplate>
                                                        <asp:Image ID="Image2" runat="server" style="height:250px;width:250px;" CssClass="img1"  ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("Image")) %>'/>
                   ...
                   <%-- <div class="home-side-banner">
                        <img alt="banner" src="img/offer1.jpg">
                    </div>--%>

                    <div class="side-banner-img"><a href="#" title="Image">
                        <img src="img/offer2.jpg" alt="Image"></a> </div>
                </div>
