<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foodpage.aspx.cs" Inherits="Foodpage" %>
                        ...
                        <div class="col-md-6 col-md-offset-6">
                          <div class="search-box" style="height:60px;" >
                                  ...
                                  <p style=" margin-left:7px; margin-top:10px;"><asp:TextBox  runat="server" placeholder="Search brands,products,events,movies by malls" MaxLength="100" name="search" CssClass="form-control"  Width="420px"  ID="txtsearch"></asp:TextBox></p>
                                    ...
                                    <p style="margin-left:450px; margin-top:-40px" ><i  class="fa fa-search"><asp:Button ID="Button2" runat="server"  Text="Search"  CssClass=" btn btn-default "  BorderWidth="0"  Height="25px" /></i></p>
            ...
            <div class="row">
             ...
             <%--       <div class="bestsell-pro">
                ...
                <table border="0">
                   ...
                   <tr> <td>
                        <asp:Image ID="Image1" runat="server" CssClass="img1" ImageUrl='<%#"data:Images/png;base64," + Convert.ToBase64String((byte[])Eval("image")) %>' Height="200" Width="200"/></td>
                       </tr>
                       <tr> <td>    
                      <asp:LinkButton ID="LinkButton7" CssClass="button btn-cart"  runat="server"  CommandName='<%#Eval("Food_Item") %>' OnClick="LinkButton7_Click">View Info</asp:LinkButton>
                         <br />
                       <b style="color:green;font-size:15px">Food Item:-</b>  <b><asp:Label ID="Label2" runat="server" Font-Size:14px  Text='<%#Eval("Food_Item") %>'></asp:Label></b>
                       </td>
                       </tr>
                    <tr>
                        <td class="abc">
                           <%--PC <asp:Label ID="Label2" runat="server" Font-Size:14px  Text='<%#Eval("P_Name") %>'></asp:Label> --%>
                        </td>
                    </tr>
                </table>
            ...
            Font-Names="Verdana" Font-Size="Small" GridLines="Both">
                   ...
                   <tr> <td>
                       <marquee DIRECTION=UP
                           ...
                           >
                        <asp:Image ID="Image1" runat="server" CssClass="img1" ImageUrl='<%#"data:Images/png;base64," + Convert.ToBase64String((byte[])Eval("image")) %>' Height="250" Width="250"/>
                           </marquee>
                           </td>
                       </tr></table>
                            </ItemTemplate>
