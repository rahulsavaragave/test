<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kids_Talent.aspx.cs" Inherits="Kids_Talent" %>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="welcome-msg" style="font-weight: bold;"><marquee behaviour="alternate">Welcome Shopping Mall </marquee> </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 space">
                                    <div class="feature-box first">
                                        ...
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Visible="false" ></asp:DropDownList>
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList2" runat="server" Visible="false" AutoPostBack="True" placeholder="select Mall Name" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList3" runat="server" Visible="false" AutoPostBack="True" placeholder="Select Shop Name" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" >
            ...
            <div class="row">
                        ...
                        <div class="navbar nav-menu">
                            <div class="navbar-collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                         <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/Kidimage.aspx">Upload</asp:LinkButton>
              ...
              <ItemTemplate>
                <table border="0">
                   ...
                   <tr> <td>
                        <asp:Image  ID="Image1"  runat="server" CssClass="img1" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("Data")) %>' Height="250" Width="250"/></td>
                       </tr>
                </table>
        ...
        <div>
              ...
              <ItemTemplate>
                <table border="0">
                   <%-- <tr ><td class="abc">offer_price Rs.<asp:Label ID="Label1" runat="server"  Text='<%#Eval("PR_OfferPrice") %>'></asp:Label></td></tr>--%>
                   <tr> <td>
                        <asp:Image  ID="Image1"  runat="server" CssClass="imgrotate" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("images")) %>' Height="200" Width="200"/></td>
                       </tr>
                </table>
            ...
            Font-Names="Verdana" Font-Size="Small" GridLines="Both">
                   ...
                   <tr> 
                       <td>
                        ...
                        <asp:Image  ID="Image1"  runat="server" CssClass="imgrotate" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("data")) %>' Height="260" Width="260"/></td>
                          </marquee>
                           </td>
                       </tr>
