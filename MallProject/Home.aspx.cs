...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            //fetch data from database display in datalist1 code
            ...
            //select Last 10 Record from  database display datalist2
            SqlDataAdapter top = new SqlDataAdapter("select TOP 8 * from ProductRegi order by PR_Id desc", con);
            ...
            SqlDataAdapter top1 = new SqlDataAdapter("select TOP 5 * from ProductRegi order by PR_Id desc", con);
