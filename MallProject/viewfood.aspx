                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 space">
                                    <div class="feature-box last">
                                        <span class="fa fa-building"></span>
                                        <div class="content">
                                            <asp:DropDownList ID="DropDownList6" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="DropDownList6_SelectedIndexChanged"></asp:DropDownList>
                                            <%--<select name="mall" class="form-control">
                   ...
                   <tr> <td>
                    ...
                    <tr ><td class="abc" font-family:'Times New Roman'; font-size:medium;" >Price Rs.<asp:Label ID="Label3" runat="server"  Text='<%#Eval("Price") %>'></asp:Label></td></tr>
                     <tr> <td>
                         ...
                         <asp:LinkButton ID="LinkButton2" runat="server" CommandName='<%#Eval("Food_Name") %>' >View Info </asp:LinkButton>
