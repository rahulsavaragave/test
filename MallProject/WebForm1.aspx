   ...
   <%-- <div class="modal fade" id="myModal88" tabindex="-1" role="dialog" aria-labelledby="myModal88"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <p style="text-align:right"><asp:Button ID="Button3" runat="server" Text="Close" CssClass="btn btn-info"   PostBackUrl="~/Home.aspx" /></p>
                                    ...
                                    <div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
                                        <div class="facts">
                                            <div class="register">
                                               ...
                                               Gender &nbsp;&nbsp; <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="form-control" >
                                                    <asp:ListItem>Male &nbsp;&nbsp;&nbsp;&nbsp; </asp:ListItem>
                                                    <asp:ListItem>Female</asp:ListItem>
                                                </asp:RadioButtonList><br />
                                                <asp:TextBox ID="txtphone" runat="server"  placeholder="Enter Phone Number"></asp:TextBox>
                                                <asp:TextBox ID="txtaddress" runat="server"  placeholder="Enter Address" Width="100%" TextMode="MultiLine"></asp:TextBox>
