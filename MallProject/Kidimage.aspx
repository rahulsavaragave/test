<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kidimage.aspx.cs" Inherits="Kidimage" %>
   ...
   <%-- <div class="modal fade" id="myModal88" tabindex="-1" role="dialog" aria-labelledby="myModal88"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <p style="text-align:right">  <asp:Button ID="Button3" runat="server" Text="Close" CssClass="btn btn-info" OnClick="Button3_Click"/>
                      
                    <h4 class="modal-title" id="myModalLabel"> Kid's Talent</h4>
                </div>
